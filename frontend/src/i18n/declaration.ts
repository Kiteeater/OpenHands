...
export enum I18nKey {
  ...
  ORG$CONFIRM_ROLE_CHANGE = "ORG$CONFIRM_ROLE_CHANGE",
  ORG$CONFIRM_ROLE_CHANGE_MESSAGE = "ORG$CONFIRM_ROLE_CHANGE_MESSAGE",
  ORG$UPDATE_MEMBER_ROLE_FAILED = "ORG$UPDATE_MEMBER_ROLE_FAILED",
  ORG$UPDATE_MEMBER_ROLE_SUCCESS = "ORG$UPDATE_MEMBER_ROLE_SUCCESS",
